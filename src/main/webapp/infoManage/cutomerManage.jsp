    ...
    <div  class="layui-form geec-tab">
        <form class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">客户公司简称：</label>
                <div class="layui-input-inline">
                    <input type="text" name="customerSimpleName" placeholder="请输入名称" class="layui-input">
                </div>
...
<div id="supplierContactTableDiv" style="display: none">
    <div class="layui-fluid">
        <table id="supplierContactTable" lay-filter="supplierContactTable"></table>
    </div>
</div>
...
<script type="text/javascript" src="../js/infoMange/customerManage.js"></script>
</body>
</html>
