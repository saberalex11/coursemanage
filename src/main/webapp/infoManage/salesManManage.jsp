    ...
    <div  class="layui-form geec-tab">
        <form class="layui-form-item">
            <div class="layui-inline">
                <label class="layui-form-label">员工中文名：</label>
                <div class="layui-input-inline">
                    <input type="text" name="chineseName" placeholder="请输入名称" class="layui-input">
                </div>
...
<script type="text/javascript" src="../js/infoMange/salesManManage.js"></script>
</body>
</html>
