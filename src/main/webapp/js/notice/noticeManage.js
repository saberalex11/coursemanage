  ...
  base: "../../js/"
    ...
    form.on('submit(searchFilter)', function (data) {
        ...
        table.on('tool(noticeTable)', function (obj) {
            ...
            if (layEvent === 'edit') {
                localStorage.editNoticeId = noticeId;
                window.location.href = "../notice/editNotice.jsp";
            }else if (layEvent === 'delete') {
                var param = {
                    "id":noticeId
                };
                $.post(baseURL+"/notice/deleteNotice.do",param,function (data){
        ...
        var noticeTableRender = table.render({
            ...
            url: baseURL + "/notice/queryMyNotice.do",
            id: 'noticeTableId',
            method: 'post',
            height: '500',
            skin: 'row',
