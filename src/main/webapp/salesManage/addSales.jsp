...
<div class="layui-container" id="newProductApp">
    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label"><em class="require">*</em>销售日期</label>
            <div class="layui-input-block">
                <input type="text" id="deliveryDate" name="deliveryDate" lay-verify="required" autocomplete="off" placeholder="采购日期" class="layui-input">
            </div>
        </div>
...
<script type="text/javascript" src="../js/salesManage/addSales.js"></script>
</html>
