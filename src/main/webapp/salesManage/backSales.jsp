...
<div class="layui-container" id="newProductApp">
    ...
    <form class="layui-form" action="">
        <div class="layui-form-item">
            <label class="layui-form-label"><em class="require">*</em>销售员</label>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label"><em class="require">*</em>客户</label>
            <div class="layui-input-block">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label"><em class="require">*</em>销售地址</label>
            <div class="layui-input-block">
                <input type="text" id="deliveryAddress" name="deliveryAddress" lay-verify="required" autocomplete="off" placeholder="销售地址" class="layui-input">
            </div>
        </div>

        <div class="layui-form-item">
            <label class="layui-form-label"><em class="require">*</em>退货日期</label>
            <div class="layui-input-block">
                <input type="text" id="deliveryDate" name="deliveryDate" lay-verify="required" autocomplete="off" placeholder="退货日期" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item" pane="">
            <label class="layui-form-label"><em class="require">*</em>销售明细</label>
            <div class="layui-input-block">
        ...
        <div class="layui-row" style="padding-top:10px;padding-bottom:20px" v-for="product in products">
            <div class="layui-col-md9" data-flag="productDetailInfo">
                ...
                <div class="layui-form-item" pane="">
                    ...
                    <div class="layui-input-block">
                        <input name="salesUnitPrice" type="text" readonly lay-verify="title" v-model="product.price" class="layui-input"/>
                    </div>
                </div>
                <div class="layui-form-item" pane="">
                    <label class="layui-form-label">数量</label>
                    <div class="layui-input-block">
                        <input name="salesQuantity" type="text" readonly lay-verify="title" v-model="product.quantity" class="layui-input"/>
                    </div>
                </div>
                <div class="layui-form-item" pane="">
                    <label class="layui-form-label">金额</label>
                    <div class="layui-input-block">
                        <input name="salesAmount"  type="text" readonly lay-verify="title" v-model="product.amount" class="layui-input"/>
                    </div>
                </div>
                <div class="layui-form-item" pane="">
                    <div class="layui-input-block">
    ...
    <div class="layui-container" style="width: 700px;padding-top: 25px">
        <form class="layui-form" action="">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">商品编号</label>
                <div class="layui-input-block">
                    <input readonly type="text" name="productId" lay-verify="number" autocomplete="off" placeholder="商品编号" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
...
<script type="text/javascript" src="../js/salesManage/backSales.js"></script>
</html>
